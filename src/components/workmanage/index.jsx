...
import { SearchBanner } from '../../pages/searchbanner/index.tsx'
import history from '../../history'
import {loading, success} from '../../pages/loading'
import './index.less'

export const WorkManagePage = () => {
  let mange = WorkManageContainer.useContainer()
  const workInfo = (text) => {
